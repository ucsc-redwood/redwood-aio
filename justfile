...
db-to-code:
    ...
    python3 scripts/analysis/gen_schedules.py --device 3A021JEHN02756 --app CifarSparse --output_dir ./data/generated-schedules/
    python3 scripts/analysis/gen_schedules.py --device 3A021JEHN02756 --app Tree --output_dir ./data/generated-schedules/
    
    python3 scripts/analysis/gen_schedules.py --device 9b034f1b --app CifarDense --output_dir ./data/generated-schedules/
    python3 scripts/analysis/gen_schedules.py --device 9b034f1b --app CifarSparse --output_dir ./data/generated-schedules/
    python3 scripts/analysis/gen_schedules.py --device 9b034f1b --app Tree --output_dir ./data/generated-schedules/
    
    python3 scripts/analysis/gen_schedules.py --device ce0717178d7758b00b7e --app CifarDense --output_dir ./data/generated-schedules/
    python3 scripts/analysis/gen_schedules.py --device ce0717178d7758b00b7e --app CifarSparse --output_dir ./data/generated-schedules/
    python3 scripts/analysis/gen_schedules.py --device ce0717178d7758b00b7e --app Tree --output_dir ./data/generated-schedules/
