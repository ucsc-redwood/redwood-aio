...
// input -> morton
void process_stage_1(AppData &appdata, TempStorage &temp_storage);

// morton -> sorted morton
void process_stage_2(AppData &appdata, TempStorage &temp_storage);

// sorted morton -> unique morton
void process_stage_3(AppData &appdata, TempStorage &temp_storage);

// unique morton -> brt
void process_stage_4(AppData &appdata, TempStorage &temp_storage);

// brt -> edge count
void process_stage_5(AppData &appdata, TempStorage &temp_storage);

// edge count -> edge offset
void process_stage_6(AppData &appdata, TempStorage &temp_storage);

// *everything above* -> octree
void process_stage_7(AppData &appdata, TempStorage &temp_storage);
