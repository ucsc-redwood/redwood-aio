...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<2, 2, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<2, 3, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<2, 6, ProcessorType::kMediumCore, 2>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<5, 6, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk3(moodycamel::ConcurrentQueue<Task>& in_q, std::vector<Task>& out_tasks) {
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<7, 7, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk3(moodycamel::ConcurrentQueue<Task>& in_q, std::vector<Task>& out_tasks) {
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<6, 7, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<3, 5, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, std::vector<Task>& out_tasks) {
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<5, 7, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<3, 4, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<4, 5, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<3, 3, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<4, 4, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<4, 6, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<2, 4, ProcessorType::kMediumCore, 2>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<2, 5, ProcessorType::kMediumCore, 2>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<5, 5, ProcessorType::kLittleCore, 3>(task);
