...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_021_chunk2(q_01, q_12); });
  std::thread t_chunk3([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_021_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_014_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_011_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_017_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_016_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_013_chunk2(q_01, q_12); });
  std::thread t_chunk3([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_013_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_018_chunk2(q_01, q_12); });
  std::thread t_chunk3([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_018_chunk3(q_12, out_tasks); });
...
void stage_group_ce0717178d7758b00b7e_Tree_schedule_022_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<2, 5, ProcessorType::kBigCore, 4>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_022_chunk2(q_01, q_12); });
  std::thread t_chunk3([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_022_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_015_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_009_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_024_chunk1(tasks, q_01); });
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_024_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_019_chunk1(tasks, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_023_chunk2(q_01, q_12); });
  std::thread t_chunk3([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_023_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk2([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_007_chunk2(q_01, q_12); });
  std::thread t_chunk3([&]() { stage_group_ce0717178d7758b00b7e_Tree_schedule_007_chunk3(q_12, out_tasks); });
