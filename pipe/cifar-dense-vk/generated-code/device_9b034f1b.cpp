...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<2, 4, ProcessorType::kLittleCore, 3>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<8, 8, ProcessorType::kMediumCore, 2>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<5, 5, ProcessorType::kMediumCore, 2>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<7, 8, ProcessorType::kMediumCore, 2>(task);
...
void chunk_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (true) {
    ...
    if (in_q.try_dequeue(task)) {
      ...
      run_cpu_stages<8, 8, ProcessorType::kLittleCore, 3>(task);
