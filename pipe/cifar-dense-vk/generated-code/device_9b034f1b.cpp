// Auto-generated aggregated source for device: 9b034f1b
// Contains all 'CifarDense' schedules for device_9b034f1b
#include "device_9b034f1b.hpp"
...
void stage_group_9b034f1b_CifarDense_schedule_006_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    ...
    if (in_q.try_dequeue(task)) {
      run_gpu_stages<2, 7>(task.app_data);
      out_q.enqueue(task);
    } else {
...
void stage_group_9b034f1b_CifarDense_schedule_006_chunk3(moodycamel::ConcurrentQueue<Task>& in_q, std::vector<Task>& out_tasks) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<8, 9, ProcessorType::kLittleCore, 3>(task.app_data);
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_006_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_006_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_006_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_037_chunk3(moodycamel::ConcurrentQueue<Task>& in_q, std::vector<Task>& out_tasks) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<7, 9, ProcessorType::kMediumCore, 2>(task.app_data);
      out_tasks.push_back(task);
      int r = tasks_in_flight.fetch_sub(1, std::memory_order_relaxed) - 1;
      if (r == 0) done.store(true, std::memory_order_release);
    } else {
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_037_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_037_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_037_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_033_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_033_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_033_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_049_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<5, 5, ProcessorType::kMediumCore, 2>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_049_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_049_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_049_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_002_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_002_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_002_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_045_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_045_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_045_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_016_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_016_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_027_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<4, 4, ProcessorType::kLittleCore, 3>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_027_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_027_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_027_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_041_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<2, 4, ProcessorType::kLittleCore, 3>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_041_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_041_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_041_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_023_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_023_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_023_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_012_chunk3(moodycamel::ConcurrentQueue<Task>& in_q, std::vector<Task>& out_tasks) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<9, 9, ProcessorType::kLittleCore, 3>(task.app_data);
      out_tasks.push_back(task);
      int r = tasks_in_flight.fetch_sub(1, std::memory_order_relaxed) - 1;
      if (r == 0) done.store(true, std::memory_order_release);
    } else {
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_012_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_012_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_012_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_044_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_044_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_044_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_017_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_017_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_017_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_026_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_026_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_040_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<2, 3, ProcessorType::kLittleCore, 3>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_040_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_040_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_040_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_022_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_022_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_022_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_013_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_013_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_007_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_gpu_stages<2, 8>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_007_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_007_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_007_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_036_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_036_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_036_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_050_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_050_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_050_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_032_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_032_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_032_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_003_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_003_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_003_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_048_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_048_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_046_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_046_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_046_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_015_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_015_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_024_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_024_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_024_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_038_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<3, 3, ProcessorType::kLittleCore, 3>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_038_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_038_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_038_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_042_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_042_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_009_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_009_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_020_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_020_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_011_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<8, 8, ProcessorType::kLittleCore, 3>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_011_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_011_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_011_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_005_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_005_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_005_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_034_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<7, 8, ProcessorType::kMediumCore, 2>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_034_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_034_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_034_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_028_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_028_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_028_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_019_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_019_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_030_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_030_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_001_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_001_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_001_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_004_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_004_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_004_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_035_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_035_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_029_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_029_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_029_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_018_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<2, 2, ProcessorType::kLittleCore, 3>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_018_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_018_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_018_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_031_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_031_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_031_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_047_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_047_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_047_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_014_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_014_chunk2, std::ref(q_01), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_025_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_025_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_025_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_039_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<3, 4, ProcessorType::kLittleCore, 3>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_039_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_039_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_039_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_008_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_008_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_008_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void stage_group_9b034f1b_CifarDense_schedule_043_chunk2(moodycamel::ConcurrentQueue<Task>& in_q, moodycamel::ConcurrentQueue<Task>& out_q) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
      run_stages<4, 4, ProcessorType::kMediumCore, 2>(task.app_data);
      out_q.enqueue(task);
    } else {
      std::this_thread::yield();
    }
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_043_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_043_chunk2, std::ref(q_01), std::ref(q_12));
  std::thread t_chunk3(stage_group_9b034f1b_CifarDense_schedule_043_chunk3, std::ref(q_12), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_021_chunk1, std::ref(tasks), std::ref(out_tasks));
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(stage_group_9b034f1b_CifarDense_schedule_010_chunk1, std::ref(tasks), std::ref(q_01));
  std::thread t_chunk2(stage_group_9b034f1b_CifarDense_schedule_010_chunk2, std::ref(q_01), std::ref(out_tasks));
