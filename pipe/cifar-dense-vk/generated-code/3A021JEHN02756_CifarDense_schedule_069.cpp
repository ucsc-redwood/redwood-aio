// Auto-generated code for schedule: 3A021JEHN02756_CifarDense_schedule_069
// Device ID: 3A021JEHN02756

#include "3A021JEHN02756_CifarDense_schedule_069.hpp"
...
namespace CifarDense_schedule_069 {
...
void stage_group_chunk2(moodycamel::ConcurrentQueue<Task>& in_q,
  ...
  while (!done.load(std::memory_order_acquire)) {
    ...
    if (in_q.try_dequeue(task)) {
      run_stages<3, 4, ProcessorType::kBigCore, 2>(task.app_data);
      out_q.enqueue(task);
    } else {
...
}  // end namespace CifarDense_schedule_069
