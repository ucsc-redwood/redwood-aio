...
static void BM_schedule_jetson_CifarDense_schedule_001(benchmark::State &state) {
...
static void BM_schedule_jetson_CifarDense_schedule_002(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_003(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_004(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_005(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_006(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_007(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_008(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_009(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_010(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_011(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_012(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_013(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_014(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_015(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_016(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetson_CifarDense_schedule_017(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_001(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_002(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_003(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_004(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_005(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_006(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_007(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_008(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_009(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_010(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_011(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_012(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_013(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_014(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_015(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_016(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_017(benchmark::State &state) {
  cuda::CudaManager mgr;
...
static void BM_schedule_jetsonlowpower_CifarDense_schedule_018(benchmark::State &state) {
  cuda::CudaManager mgr;
...
// Table of schedules for this device:
static generated_schedules::ScheduleRecord schedule_table[] = {
    {"jetsonlowpower_CifarDense_schedule_001", &BM_schedule_jetsonlowpower_CifarDense_schedule_001},
    {"jetsonlowpower_CifarDense_schedule_002", &BM_schedule_jetsonlowpower_CifarDense_schedule_002},
    {"jetsonlowpower_CifarDense_schedule_003", &BM_schedule_jetsonlowpower_CifarDense_schedule_003},
    {"jetsonlowpower_CifarDense_schedule_004", &BM_schedule_jetsonlowpower_CifarDense_schedule_004},
    {"jetsonlowpower_CifarDense_schedule_005", &BM_schedule_jetsonlowpower_CifarDense_schedule_005},
    {"jetsonlowpower_CifarDense_schedule_006", &BM_schedule_jetsonlowpower_CifarDense_schedule_006},
    {"jetsonlowpower_CifarDense_schedule_007", &BM_schedule_jetsonlowpower_CifarDense_schedule_007},
    {"jetsonlowpower_CifarDense_schedule_008", &BM_schedule_jetsonlowpower_CifarDense_schedule_008},
    {"jetsonlowpower_CifarDense_schedule_009", &BM_schedule_jetsonlowpower_CifarDense_schedule_009},
    {"jetsonlowpower_CifarDense_schedule_010", &BM_schedule_jetsonlowpower_CifarDense_schedule_010},
    {"jetsonlowpower_CifarDense_schedule_011", &BM_schedule_jetsonlowpower_CifarDense_schedule_011},
    {"jetsonlowpower_CifarDense_schedule_012", &BM_schedule_jetsonlowpower_CifarDense_schedule_012},
    {"jetsonlowpower_CifarDense_schedule_013", &BM_schedule_jetsonlowpower_CifarDense_schedule_013},
    {"jetsonlowpower_CifarDense_schedule_014", &BM_schedule_jetsonlowpower_CifarDense_schedule_014},
    {"jetsonlowpower_CifarDense_schedule_015", &BM_schedule_jetsonlowpower_CifarDense_schedule_015},
    {"jetsonlowpower_CifarDense_schedule_016", &BM_schedule_jetsonlowpower_CifarDense_schedule_016},
    {"jetsonlowpower_CifarDense_schedule_017", &BM_schedule_jetsonlowpower_CifarDense_schedule_017},
    {"jetsonlowpower_CifarDense_schedule_018", &BM_schedule_jetsonlowpower_CifarDense_schedule_018},
};
static const size_t schedule_count = sizeof(schedule_table) / sizeof(schedule_table[0]);
}  // namespace device_jetsonlowpower
