...
static void BM_schedule_jetson_Tree_schedule_001(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, cuda::run_multiple_stages<1, 4>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kLittleCore, 6>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_002(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, cuda::run_multiple_stages<1, 5>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kLittleCore, 6>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_003(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 6>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, cuda::run_multiple_stages<3, 7>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_004(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, cuda::run_multiple_stages<1, 3>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, omp::run_multiple_stages<4, 7, ProcessorType::kLittleCore, 6>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_005(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kLittleCore, 6>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, cuda::run_multiple_stages<4, 7>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_006(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, cuda::run_multiple_stages<1, 6>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 6>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_007(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, cuda::run_multiple_stages<1, 2>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, omp::run_multiple_stages<3, 7, ProcessorType::kLittleCore, 6>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_008(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 6>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, cuda::run_multiple_stages<2, 7>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_009(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, nullptr, cuda::run_multiple_stages<1, 7>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_010(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 4, ProcessorType::kLittleCore, 6>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, cuda::run_multiple_stages<5, 7>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_011(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 5, ProcessorType::kLittleCore, 6>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, cuda::run_multiple_stages<6, 7>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_012(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 6, ProcessorType::kLittleCore, 6>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, cuda::run_multiple_stages<7, 7>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_013(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, &q_0_1, cuda::run_multiple_stages<1, 1>, mgr); });
        std::thread t2([&]() { chunk<Task, tree::AppData>(q_0_1, nullptr, omp::run_multiple_stages<2, 7, ProcessorType::kLittleCore, 6>, mgr); });
...
static void BM_schedule_jetson_Tree_schedule_014(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::AppData>(q_input, nullptr, omp::run_multiple_stages<1, 7, ProcessorType::kLittleCore, 6>, mgr); });
