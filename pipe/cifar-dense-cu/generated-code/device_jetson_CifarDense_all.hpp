...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t2([&]() {
    chunk<Task, AppData>(q_0_1, nullptr, omp::run_multiple_stages<8, 9, ProcessorType::kLittleCore, 6>, mgr);
  });
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t2([&]() {
    chunk<Task, AppData>(q_0_1, nullptr, omp::run_multiple_stages<9, 9, ProcessorType::kLittleCore, 6>, mgr);
  });
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t1([&]() {
    chunk<Task, AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 6>, mgr);
  });
  std::thread t2([&]() {
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t1([&]() {
    chunk<Task, AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 6>, mgr);
  });
  std::thread t2([&]() {
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t1([&]() {
    chunk<Task, AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kLittleCore, 6>, mgr);
  });
  std::thread t2([&]() {
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t1([&]() {
    chunk<Task, AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 4, ProcessorType::kLittleCore, 6>, mgr);
  });
  std::thread t2([&]() {
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t2([&]() {
    chunk<Task, AppData>(q_0_1, nullptr, omp::run_multiple_stages<7, 9, ProcessorType::kLittleCore, 6>, mgr);
  });
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t1([&]() {
    chunk<Task, AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 5, ProcessorType::kLittleCore, 6>, mgr);
  });
  std::thread t2([&]() {
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t2([&]() {
    chunk<Task, AppData>(q_0_1, nullptr, omp::run_multiple_stages<6, 9, ProcessorType::kLittleCore, 6>, mgr);
  });
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t1([&]() {
    chunk<Task, AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 6, ProcessorType::kLittleCore, 6>, mgr);
  });
  std::thread t2([&]() {
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t2([&]() {
    chunk<Task, AppData>(q_0_1, nullptr, omp::run_multiple_stages<5, 9, ProcessorType::kLittleCore, 6>, mgr);
  });
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t2([&]() {
    chunk<Task, AppData>(q_0_1, nullptr, omp::run_multiple_stages<4, 9, ProcessorType::kLittleCore, 6>, mgr);
  });
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t2([&]() {
    chunk<Task, AppData>(q_0_1, nullptr, omp::run_multiple_stages<3, 9, ProcessorType::kLittleCore, 6>, mgr);
  });
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t2([&]() {
    chunk<Task, AppData>(q_0_1, nullptr, omp::run_multiple_stages<2, 9, ProcessorType::kLittleCore, 6>, mgr);
  });
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t1([&]() {
    chunk<Task, AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 7, ProcessorType::kLittleCore, 6>, mgr);
  });
  std::thread t2([&]() {
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t1([&]() {
    chunk<Task, AppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 8, ProcessorType::kLittleCore, 6>, mgr);
  });
  std::thread t2([&]() {
...
inline void run_pipeline(const int num_tasks)
{
  ...
  std::thread t_only([&]() {
    chunk<Task, AppData>(q_input, nullptr, omp::run_multiple_stages<1, 9, ProcessorType::kLittleCore, 6>, mgr);
  });
