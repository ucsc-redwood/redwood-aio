...
// -----------------------------------------------------------------------------
// Schedule 001: 9b034f1b_CifarSparse_schedule_022
// Device: 9b034f1b
...
// -----------------------------------------------------------------------------
// Schedule 002: 9b034f1b_CifarSparse_schedule_043
// Device: 9b034f1b
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 003: 9b034f1b_CifarSparse_schedule_013
// Device: 9b034f1b
// Application: CifarSparse
// Chunks: 2
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 004: 9b034f1b_CifarSparse_schedule_002
// Device: 9b034f1b
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 005: 9b034f1b_CifarSparse_schedule_031
// Device: 9b034f1b
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 006: 9b034f1b_CifarSparse_schedule_040
// Device: 9b034f1b
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 007: 9b034f1b_CifarSparse_schedule_001
// Device: 9b034f1b
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 008: 9b034f1b_CifarSparse_schedule_007
// Device: 9b034f1b
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 009: 9b034f1b_CifarSparse_schedule_047
// Device: 9b034f1b
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 010: 9b034f1b_CifarSparse_schedule_008
// Device: 9b034f1b
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 001: 3A021JEHN02756_CifarSparse_schedule_022
...
// -----------------------------------------------------------------------------
// Schedule 002: 3A021JEHN02756_CifarSparse_schedule_043
// Device: 3A021JEHN02756
// Application: CifarSparse
// Chunks: 4
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 003: 3A021JEHN02756_CifarSparse_schedule_013
// Device: 3A021JEHN02756
// Application: CifarSparse
// Chunks: 4
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 004: 3A021JEHN02756_CifarSparse_schedule_002
// Device: 3A021JEHN02756
// Application: CifarSparse
// Chunks: 4
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 005: 3A021JEHN02756_CifarSparse_schedule_031
// Device: 3A021JEHN02756
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 006: 3A021JEHN02756_CifarSparse_schedule_040
// Device: 3A021JEHN02756
// Application: CifarSparse
// Chunks: 4
// -----------------------------------------------------------------------------
...
static void BM_schedule_3A021JEHN02756_CifarSparse_schedule_040(benchmark::State &state) {
  ...
  for (auto _ : state) {
    ...
    std::thread t3([&]() {
      chunk<Task, cifar_sparse::AppData>(
          q_1_2, &q_2_3, omp::run_multiple_stages<5, 6, ProcessorType::kLittleCore, 4>);
    });
    std::thread t4([&]() {
      chunk<Task, cifar_sparse::AppData>(
...
// -----------------------------------------------------------------------------
// Schedule 007: 3A021JEHN02756_CifarSparse_schedule_001
// Device: 3A021JEHN02756
// Application: CifarSparse
// Chunks: 4
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 008: 3A021JEHN02756_CifarSparse_schedule_007
// Device: 3A021JEHN02756
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Schedule 009: 3A021JEHN02756_CifarSparse_schedule_047
// Device: 3A021JEHN02756
// Application: CifarSparse
// Chunks: 4
// -----------------------------------------------------------------------------
...
static void BM_schedule_3A021JEHN02756_CifarSparse_schedule_047(benchmark::State &state) {
  ...
  for (auto _ : state) {
    ...
    std::thread t3(
        [&]() { chunk<Task, cifar_sparse::AppData>(q_1_2, &q_2_3, vulkan::run_gpu_stages<3, 6>); });
    std::thread t4([&]() {
      chunk<Task, cifar_sparse::AppData>(
          q_2_3, nullptr, omp::run_multiple_stages<7, 9, ProcessorType::kLittleCore, 4>);
    });
...
// -----------------------------------------------------------------------------
// Schedule 010: 3A021JEHN02756_CifarSparse_schedule_008
// Device: 3A021JEHN02756
// Application: CifarSparse
// Chunks: 3
// -----------------------------------------------------------------------------
