...
static void BM_schedule_3A021JEHN02756_Tree_schedule_001(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 4>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 3, ProcessorType::kBigCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_002(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kBigCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<3, 3, ProcessorType::kLittleCore, 4>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_003(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<5, 5, ProcessorType::kLittleCore, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_004(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 4>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_005(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<3, 3, ProcessorType::kLittleCore, 4>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_006(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_009(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 4>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<3, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_010(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 4>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 2, ProcessorType::kBigCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<3, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_011(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<5, 5, ProcessorType::kLittleCore, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_012(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<5, 5, ProcessorType::kLittleCore, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_014(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kBigCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_019(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kBigCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<5, 5, ProcessorType::kLittleCore, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_023(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<5, 6, ProcessorType::kBigCore, 2>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 4>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_024(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kBigCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<5, 6, ProcessorType::kMediumCore, 2>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 4>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_027(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 4>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 5>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_031(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 5>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<6, 6, ProcessorType::kLittleCore, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_032(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 5>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<6, 6, ProcessorType::kBigCore, 2>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 4>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_033(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 5>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<6, 6, ProcessorType::kLittleCore, 4>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_034(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kBigCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 5>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, &q_2_3, omp::run_multiple_stages<6, 6, ProcessorType::kMediumCore, 2>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 4>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_035(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 5>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_036(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kBigCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 5>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_041(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 4>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 6>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kBigCore, 2>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_043(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 3, ProcessorType::kBigCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 6>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 4>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_044(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kBigCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 6>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 4>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_046(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<3, 3, ProcessorType::kBigCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 6>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 4>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_048(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kBigCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<3, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, &q_2_3, vulkan::run_gpu_stages<4, 6>); });
        std::thread t4([&]() { chunk<Task, tree::SafeAppData>(q_2_3, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 4>); });
...
static void BM_schedule_3A021JEHN02756_Tree_schedule_049(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 6>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 4>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_001(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 5>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kLittleCore, 3>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_002(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 6>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 3>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_003(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 5>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kLittleCore, 3>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_004(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 6>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 3>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_005(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_007(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 6>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_008(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kLittleCore, 3>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_010(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<4, 4>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_013(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<4, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_014(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 3, ProcessorType::kLittleCore, 3>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<4, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_016(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<3, 3, ProcessorType::kLittleCore, 3>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<4, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_017(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, nullptr, vulkan::run_gpu_stages<4, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_021(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 2, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<3, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_022(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<3, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_023(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, nullptr, vulkan::run_gpu_stages<3, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_027(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<4, 4, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<5, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_028(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<3, 4, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<5, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_029(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<4, 5, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<6, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_030(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<4, 6, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<7, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_031(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<3, 5, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<6, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_032(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<3, 6, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<7, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_033(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 4, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<5, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_034(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_input, &q_0_1, vulkan::run_gpu_stages<1, 1>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 4, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<5, 7, ProcessorType::kLittleCore, 3>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_035(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 5, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<6, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_037(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_input, &q_0_1, vulkan::run_gpu_stages<1, 1>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 3, ProcessorType::kLittleCore, 3>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<4, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_038(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<3, 3>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<4, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_039(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, nullptr, omp::run_multiple_stages<4, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_041(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 3, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<4, 4, ProcessorType::kLittleCore, 3>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<5, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_042(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 1, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 6, ProcessorType::kMediumCore, 2>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<7, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_044(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_input, &q_0_1, vulkan::run_gpu_stages<1, 1>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<2, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<3, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_045(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 2, ProcessorType::kLittleCore, 3>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, nullptr, omp::run_multiple_stages<3, 7, ProcessorType::kMediumCore, 2>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_047(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 4, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<5, 5, ProcessorType::kLittleCore, 3>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<6, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_048(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 4, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<5, 5>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<6, 7, ProcessorType::kLittleCore, 3>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_049(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 4, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::SafeAppData>(q_0_1, &q_1_2, omp::run_multiple_stages<5, 6, ProcessorType::kLittleCore, 3>); });
        std::thread t3([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_1_2, nullptr, vulkan::run_gpu_stages<7, 7>); });
...
static void BM_schedule_9b034f1b_Tree_schedule_050(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ...
        std::thread t1([&]() { chunk<Task, tree::SafeAppData>(q_input, &q_0_1, omp::run_multiple_stages<1, 4, ProcessorType::kMediumCore, 2>); });
        std::thread t2([&]() { chunk<Task, tree::vulkan::VkAppData_Safe>(q_0_1, &q_1_2, vulkan::run_gpu_stages<5, 6>); });
        std::thread t3([&]() { chunk<Task, tree::SafeAppData>(q_1_2, nullptr, omp::run_multiple_stages<7, 7, ProcessorType::kLittleCore, 3>); });
