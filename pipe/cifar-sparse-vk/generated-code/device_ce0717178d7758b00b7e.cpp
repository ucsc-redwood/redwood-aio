...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_005_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_005_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_003_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_003_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_003_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_002_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_002_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_013_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_013_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_006_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_006_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_006_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_014_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_014_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_020_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_020_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_020_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_011_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_011_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_011_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_015_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_015_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_015_chunk3(q_12, out_tasks); });
...
void stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_019_chunk1(
    std::vector<Task>& in_tasks, std::vector<Task>& out_tasks) {
  for (auto& task : in_tasks) {
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1([&]() {
    stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_019_chunk1(tasks, out_tasks);
  });
...
void stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_004_chunk3(
    moodycamel::ConcurrentQueue<Task>& in_q, std::vector<Task>& out_tasks) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_004_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_004_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_004_chunk3(q_12, out_tasks); });
...
void stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_012_chunk3(
    moodycamel::ConcurrentQueue<Task>& in_q, std::vector<Task>& out_tasks) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_012_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_012_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_012_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_008_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_008_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_010_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_010_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_009_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_009_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_009_chunk3(q_12, out_tasks); });
...
void stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_016_chunk3(
    moodycamel::ConcurrentQueue<Task>& in_q, std::vector<Task>& out_tasks) {
  while (!done.load(std::memory_order_acquire)) {
    Task task;
    if (in_q.try_dequeue(task)) {
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_016_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_016_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_016_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_018_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_018_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_001_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_001_chunk2(q_01, q_12); });
  std::thread t_chunk3(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_001_chunk3(q_12, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_007_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_007_chunk2(q_01, out_tasks); });
...
void run_pipeline(std::vector<Task>& tasks, std::vector<Task>& out_tasks) {
  ...
  std::thread t_chunk1(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_017_chunk1(tasks, q_01); });
  std::thread t_chunk2(
      [&]() { stage_group_ce0717178d7758b00b7e_CifarSparse_schedule_017_chunk2(q_01, out_tasks); });
